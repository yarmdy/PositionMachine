...
(function(factory) {
    ...
    $.validator.config({
        ...
        rules: {
            ...
            , username: [/^\w{3,12}$/, "please enter 3-12 numbers or letter or underline"]
            , password: [/^[\S]{6,16}$/, "please enter 6-16 chars，that contains no spaces"]
            , mobile: [/^1[3-9]\d{9}$/, "please enter a valid mobile phone"]
